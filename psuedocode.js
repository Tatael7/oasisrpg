//MVC - forced Media Query to Landscape


//2 menu (title, new game, log in, leader board)
//3 Game Starts- Talk to GOLD- go to club or district
//4 Walking, Directional choices(3 crossroads), weapons
//5  VS screenCombat vs Sardaukar - Top 2/3 is character Renderings, 
//5.2 Z index for text, bottom 1/3 is controls, 1 Attack, 1 Pulse Attack, Personal Stats, Directional,  Enemy Stats
//6 Outcome text

//API sheets for characters
